...
Namespace RnrBooksDataSetTableAdapters
    ...
    Partial Public Class BooksTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.CH10_Details.My.MySettings.Default.RnrBooksConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT ISBN, Title, Author, Publisher, Subject_Code, Shelf_Location, Fiction FROM"& _ 
                " Books"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As RnrBooksDataSet.BooksDataTable) As Integer
